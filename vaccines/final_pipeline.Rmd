...
<!--
should have been STANDALONE NOTEBOOK but now they are connected. This file used to depend on objects created only inside
...
```{r setup_second, message=FALSE, warning=FALSE}
knitr::opts_chunk$set(
